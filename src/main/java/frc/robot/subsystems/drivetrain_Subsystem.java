...
public void initDefaultCommand() {
   ...
   // rotate = -angle * kp - rotate;
    ...
    public void communication (){//writes to the arduino 
   ...
   /* SerialPort Por = new SerialPort(9600, Port.kUSB2);
    Por.reset();
    byte[] myBoi = Por.read(1000); 
    //SmartDashboard.putByte("arduinoValue", Por.read(1000));
    System.out.print(1);
    */
